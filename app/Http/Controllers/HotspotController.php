...
class HotspotController extends Controller
{
    ...
    public function storePackage(Request $request, Hotspot $hotspot)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'duration_value' => 'nullable|numeric|min:0.1',
            'duration_unit' => 'nullable|string|in:minutes,hours,days,weeks,months',
        ...
        try {
            ...
            $packageData = [
                ...
                'description' => $request->description ?? '',
                'price' => $request->price,
                'duration_value' => $request->duration_value ? (float)$request->duration_value : null,
